		...
		<view class="header" :style="[{height:CustomBar + 'px'},{top:jpHeight + 'px'}]">
			<view class="cu-bar bg-white" :style="{'height': CustomBar + 'px','padding-top':StatusBar + 'px'}">
				...
				<view class="action" @tap="submit">
					...
					<button class="cu-btn round bg-shojo">发布</button>
				</view>
				<!--  #endif -->
		...
		<form>
			...
			<view class="cu-form-group">
				...
				<view class="picker" @tap="toCategory">
					...
					<block v-else>
						<text class="text-shojo">已选择</text>
					</block>
			...
			<view class="cu-form-group" style="background-color: rgb(0, 0, 0,0);">
				<textarea maxlength="-1" v-if="!isShow" class="text" :adjust-position="false" :focus="false" @input="textareaAInput" v-model="text" placeholder="输入帖子内容,注意排版和用词规范" :style="poststyle" @focus="ToisText(1)" @blur="ToisText(0)"></textarea>
			...
			<view class="cu-dialog">
				...
				<view class="padding-xl">
					<view class="padding flex flex-direction">
						<button class="cu-btn bg-blue lg" @tap="upload">直接上传</button>
						<button class="cu-btn line-red margin-tb-sm lg" @tap="goImgData">素材库选择</button>
					</view>
				</view>
			...
			<view class="setShop-box">
				<view class="setShop-main">
					...
					<view class="setShop-btn text-center">
						<text class="cu-btn radius bg-shojo" @tap="toAddShop">添加商品</text>
					</view>
				</view>
			</view>
		</view>
